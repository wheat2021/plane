export default {
  ...
  email: "邮箱",
  display_name: "显示名称",
  enter_first_name: "请输入您的名",
  enter_last_name: "请输入您的姓",
  enter_display_name: "请输入您的显示名称",
  enter_email: "请输入您的邮箱",
  role: "角色",
  timezone: "时区",
  avatar: "头像",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      work_item_types: {
        title: "工作项类型",
        page_label: "{workspace} - 工作项类型",
        description: "管理此工作区的工作项类型。系统类型不可重命名或删除。",
        add_type: "+ 新建类型",
        create_success: "工作项类型创建成功",
        update_success: "工作项类型更新成功",
        delete_success: "工作项类型已删除，共迁移 {count} 个工作项。",
        system_name_readonly: "系统类型名称不可修改",
        icon_search_placeholder: "搜索图标...",
        icon_search_hint: "输入关键词搜索图标",
        icon_no_results: "未找到图标",
        select_icon: "选择图标",
        select_color: "选择颜色",
        invalid_hex: "无效的 HEX 颜色格式（如 #ef4444）",
        form: {
          name_placeholder: "输入类型名称",
          name_required: "名称为必填项",
          description: "描述",
          description_placeholder: "输入可选描述",
        },
        delete_title: "删除工作项类型",
        delete_description: '确定要删除"{name}"吗？此操作无法撤消。',
        delete_impact: "此操作影响 {projects} 个项目，将迁移 {issues} 个工作项至各项目的默认类型。",
        delete_migrate_note: "工作项将迁移至各项目的默认类型。",
        delete_blocked: "以下项目只启用了该类型，请先为其启用其他类型：",
        confirm_delete: "确认删除",
      },
    },
    empty_state: {
