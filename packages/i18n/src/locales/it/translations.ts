  ...
  workspace_settings: {
    ...
    settings: {
      ...
      work_item_types: {
        ...
        page_label: "{workspace} - Work Item Types",
        description: "Manage work item types for this workspace. System types cannot be renamed or deleted.",
        add_type: "+ New Type",
        create_success: "Work item type created successfully",
        update_success: "Work item type updated successfully",
        delete_success: "Work item type deleted. {count} work items migrated.",
        system_name_readonly: "System type name cannot be modified",
        icon_search_placeholder: "Search icons...",
        icon_search_hint: "Enter a keyword to search icons",
        icon_no_results: "No icons found",
        select_icon: "Select Icon",
        select_color: "Select Color",
        invalid_hex: "Invalid HEX color format (e.g. #ef4444)",
        form: {
        ...
        delete_title: "Delete Work Item Type",
        delete_description: 'Are you sure you want to delete "{name}"? This action cannot be undone.',
        delete_impact:
          "This affects {projects} project(s) and will migrate {issues} work item(s) to each project's default type.",
        delete_migrate_note: "Work items will be migrated to each project's default type.",
        delete_blocked: "Some projects only have this type enabled. Please enable another type first:",
