...
- [x] 1.1 提交 OpenSpec 变更文档（proposal.md、design.md、specs/permissions/spec.md、tasks.md）
...
- [x] 4.1 提交后端权限变更（commit 信息：`#FICC-9999# fix(permissions): 收紧 Project 创建权限，仅允许 Workspace Admin 操作`）
- [x] 4.2 提交前端权限变更（commit 信息：`#FICC-9999# fix(permissions): 收紧前端 Project 创建和归档权限守卫`）

## 5. 用户验证

- [x] 5.1 以 Workspace Member 账号登录，验证「新建 Project」按钮不可见 ✅ 2026-03-05
- [x] 5.2 以 Workspace Member 账号调用 POST `/api/v1/{slug}/projects/` 接口，验证返回 403 Forbidden ✅ 2026-03-05
- [x] 5.3 以 Workspace Member 账号进入某 Project，验证 Archive 按钮不显示 ✅ 2026-03-05
- [x] 5.4 以 Workspace Member 账号调用 POST `/api/v1/{slug}/projects/{id}/archive/` 接口，验证返回 403 Forbidden ✅ 2026-03-05
- [x] 5.5 以 Workspace Admin 账号登录，验证「新建 Project」、Archive 按钮均正常可见且可操作 ✅ 2026-03-05
