...
- [x] 7.1 清除 localStorage 后访问 `http://localhost:3000`，确认界面默认为中文 ✅ 2026-03-03
- [x] 7.2 以新用户身份登录，确认 Onboarding 只显示 Profile Setup 步骤，完成后直接进入主界面 ✅ 2026-03-03
- [x] 7.3 登录页确认无 "By creating an account..." 服务条款文本 ✅ 2026-03-03
- [x] 7.4 登录页确认无 "Join 10,000+ teams building with Plane" 品牌推广区块 ✅ 2026-03-03
- [x] 7.5 确认侧边栏 "便签"、"更多"/"收起" 显示为中文 ✅ 2026-03-03
- [x] 7.6 确认项目子页面标题（工作项、周期、模块、视图、页面、收集、归档）显示为中文 ✅ 2026-03-03
