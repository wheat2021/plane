# Condition Extra Properties

## Purpose

定义 extra property 的条件显示功能：select/multiselect 的选项和 checkbox 的 true/false 状态可关联另一个 ExtraPropertyConfig 作为条件属性，在 sidebar/list/kanban/spreadsheet 中根据父属性值条件显示/可编辑。
